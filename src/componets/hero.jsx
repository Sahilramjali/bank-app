    ...
    return(
        <section id="home" className={`flex md:flex-row flex-col ${styles.paddingY}`}>
            ...
            `}>
                ...
                <h1 className='font-poppins text-white font-semibold text-[52px]  ss:leading-[100.8px] leading-[75px] w-full'>
                    Payment Method.
                </h1>
            ...
            <div className={`flex-1 flex ${styles.flexCenter} relative md:my-0 my-10 `}>
                ...
                <div className='absolute z-[0] blue__gradient w-[50%] h-[50%] right-20 bottom-20'/>
            </div>
